...
- (void)viewDidLoad
{
//    _dict = [NSDictionary dictionaryWithObjectsAndKeys:@"",KEY_NAVIGATION_LEFT_BUTTON_ITEM_TITLE, @"", KEY_NAVIGATION_RIGHT_BUTTON_ITEM_TITLE,@"联系我们",KEY_NAVIGATION_TITLE, VALUE_NAVIGATION_USING_NAVIGATION, KEY_NAVICATION_IS_USING,VALUE_NAVIGATION_USING_LEFT_BUTTON_ITEM, KEY_NAVIGATION_USING_LEFT_BUTTON_ITEM,
...
- (void)initViews {
 ...
 UILabel *phoneLabel =    [self addContent:@"电话:(8610) 65055996" rect:CGRectMake(contactUSTitle.frame.origin.x, contactUSTitle.frame.origin.y + contactUSTitle.frame.size.height + distY, bg.frame.size.width - 50, bg.frame.size.height) parentView:bg];
    ...
    UILabel *descLabel =    [self addContent:@"高和资本正在积极寻找和筛选适合整体收购的商业地产项目，如果您有合适的项目推荐（项目仅限一线城市和1.5线城市核心位置的商办物业），发邮件至：lihuizhong@gohighfund.com" rect:CGRectMake(codeLabel.frame.origin.x, codeLabel.frame.origin.y + codeLabel.frame.size.height + 5*distY, bg.frame.size.width - 50, bg.frame.size.height) parentView:bg];
