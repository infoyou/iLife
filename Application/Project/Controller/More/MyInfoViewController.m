...
@interface MyInfoViewController () <UIWebViewDelegate, UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate> {
    UIWebView *wView;
...
- (void)initData {
    ...
    [reqContentDic setObject:[[AppManager instance] specialWithInvokeType:INVOKETYPE_EDITUSERINFO specifieduserID:[AppManager instance].userId] forKey:KEY_API_SPECIAL];
}
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if ([url hasPrefix:@"http://goapp/?data="]) {
        ...
        NSString *desc = [CommonMethod saveUserProfileWithParam:paramDic];
        ...
        if (desc == nil || [desc isEqualToString:@""]) {
            ...
            [WXWUIUtils showNotificationOnTopWithMsg:desc
                                             msgType:INFO_TY
                                  belowNavigationBar:YES];
        }
