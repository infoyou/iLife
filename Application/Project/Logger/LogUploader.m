...
//            if (1)
        {
            ...
            NSData *res = [syncConn uploadLogData:dic
                                             data:data
                                      logFileName:beUploadedZipFileName];
