...
// -------- PG start --------
#define API_PG_USER_LOGIN          @"PGLogin"
#define API_PG_SERVICE_GROUP       @"PG/PGGroupHandler.ashx?action="
// -------- PG end --------

// TODO 正式接口

// Library
#define API_SERVICE_LIB        @"Product/MobileLibrary/MobileLibraryHandler.ashx?action="
#define API_COURSE_CATEGORY_TYPE      @"GetOnlineCourseCategory"
#define API_COURSE_LIST_TYPE          @"GetOnlineCourseList"
#define API_COURSE_SEARCH_TYPE        @"SearchCourse"
#define API_COURSE_DETAIL_TYPE        @"GetOnlineCourseDetail"
#define API_COURSE_ADD_FAVORITE_TYPE        @"SetFavorite"
#define API_COURSE_GET_FAVORITE_TYPE        @"GetFavorite"
#define API_COURSE_COMMENT_TYPE        @"GetOnlineCourseCommentList"
#define API_COURSE_COMMENT_ADD_TYPE        @"SetComment"
#define API_COURSE_TEST_TYPE        @"GetOnlineCourseTestInfo"
//#define API_COURSE_FAVORITE_TYPE        @"SetFavorite"

// Test
#define API_TEST_LIB        @"Product/MobileSurveyTest/MobileSurveyTestHandler.ashx?action="
#define API_TEST_LIST_TYPE      @"GetSurveyTestList"
#define API_TEST_DETAIL_TYPE    @"GetSurveyTestDetail"
#define API_TEST_CONTENT_TYPE   @"GetTestPaper"
#define API_TEST_ANSWER_TYPE    @"GetLastAnswerSheet"
#define API_TEST_SUBMIT_TYPE    @"SubmitSurveyTest"
#define API_TEST_VERIFY_TYPE    @"VerifySingleAnswer"
...
// Order
#define API_ORDER_LIST          @"getOrderNoPay"
#define API_ORDER_COMPLETED_LIST          @"getCompletedOrder"
#define API_ORDER_CANCEL        @"CancelOrder"
#define API_ORDER_PAY           @"PayOrder"
#define API_ORDER_EVALUATION    @"Evaluation"
#define API_SELLER_PRIORITY     @"SetPrioritySeller"
...
#define API_GET_SYSTEM_MESSAGE  @"GetMessageList"
#define API_GET_ORDER_DETAIL    @"GetOrderDetail"
...
#define API_FEED_BACK           @"SubmitUserFeedback"
