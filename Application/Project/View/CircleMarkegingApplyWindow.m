...
//        startX = _marginX;
        ...
        [_cancelButton setTitle:LocaleStringForKey(NSCancelTitle, nil) forState:UIControlStateNormal];
        ...
        [_okButton setTitle:LocaleStringForKey(NSSureTitle, nil) forState:UIControlStateNormal];
        //        _okButton.layer.allowsEdgeAntialiasing = YES;
        //        _okButton.layer.cornerRadius= 5.0f;
...
- (void)showCustomizedAlertAnimationIsOverWithUIView:(UIView *)v{
    DLog(@"showCustomizedAlertAnimationIsOverWithUIView");
...
{
    DLog(@"dismissCustomizedAlertAnimationIsOverWithUIView");
