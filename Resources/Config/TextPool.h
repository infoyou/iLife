...
#pragma mark - Lib
static NSString *const NSLibSegmentedAllTitle = @"libSegmentedAllTitle";
static NSString *const NSLibSegmentedMyTitle = @"libSegmentedMyTitle";
static NSString *const NSLibFliterTypeTitle = @"libFliterTypeTitle";
static NSString *const NSLibFliterOrderTitle = @"libFliterOrderTitle";

#pragma mark - Test
static NSString *const NSSurveyTitle        = @"surveyTitle";
static NSString *const NSTestTitle        = @"testTitle";

#pragma mark - login page
static NSString *const NSLoginTitle = @"loginTitle";
static NSString *const NSAutoLoginTitle = @"autoLoginTitle";
...
static NSString *const NSChangeSkin = @"changeSkin";
static NSString *const NSSwitchLanguage = @"switchLanguage";
static NSString *const NSClearMemory = @"clearMemory";
static NSString *const NSSoftAbout = @"softAbout";

#pragma mark - modify pswd
static NSString *const NSOrginPswdTitle = @"orginPswdTitle";
static NSString *const NSNewPswdTitle = @"newPswdTitle";
static NSString *const NSConfimPswdTitle = @"confimPswdTitle";
...
static NSString *const NSLevelTitle = @"levelTitle";
static NSString *const NSSettingsTitle = @"settingsTitle";
static NSString *const NSVersionTitle = @"versionTitle";
static NSString *const NSFeedbackMsg        = @"feedbackMsg";
static NSString *const NSPositionTitle  = @"positionTitle";
static NSString *const NSDeptTitle  = @"deptTitle";
static NSString *const NSMobileTitle  = @"mobileTitle";
static NSString *const NSTelTitle  = @"telTitle";

#pragma mark - chat
static NSString *const NSInputPromptTitle = @"inputPromptTitle";
static NSString *const NSInputPromptPhotoLibTitle = @"inputPromptPhotoLibTitle";
static NSString *const NSInputPromptTakePhotoTitle = @"inputPromptTakePhotoTitle";
static NSString *const NSInputPromptLocationTitle = @"inputPromptLocationTitle";

#pragma mark - common
static NSString *const NSUpdateSuccessTitle = @"updateSuccessTitle";
