              ...
              completion:(void(^) (BOOL cancelled))completion
{
    ...
    if (self) {
        ...
        _alertView.backgroundColor = [UIColor colorWithHexString:@"0xf2f2f2"];
        ...
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0,
                                                                ...
                                                                AlertViewWidth,
                                                                40)];
//        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, AlertViewWidth, 40)];
...
//        _titleLabel.frame = [self adjustLabelFrameHeight:self.titleLabel];
        ...
        lineLayer.frame = CGRectMake(0, _messageLabel.frame.origin.y + _messageLabel.frame.size.height + AlertViewVerticalElementSpace, AlertViewWidth, .5);
        ...
        [_cancelButton addTarget:self action:@selector(dismissAlert:) forControlEvents:UIControlEventTouchUpInside];
...
//        CGFloat buttonsY = self.frame.size.height - AlertViewButtonHeight;
        if (otherTitle) {
            ...
            [_otherButton setTitleColor:[UIColor colorWithHexString:@"0xe83e0b"] forState:UIControlStateNormal];
            [_otherButton setTitleColor:[UIColor colorWithWhite:0.25 alpha:1] forState:UIControlStateHighlighted];
            [_otherButton addTarget:self action:@selector(dismissAlert:) forControlEvents:UIControlEventTouchUpInside];
            ...
            CALayer *lineLayer = [CALayer layer];
            lineLayer.backgroundColor = [[UIColor lightGrayColor] CGColor];
            lineLayer.frame = CGRectMake(_otherButton.frame.origin.x, _otherButton.frame.origin.y, .5, AlertViewButtonHeight);
            [_alertView.layer addSublayer:lineLayer];
