...
@interface MJPhotoBrowser () <MJPhotoViewDelegate, SDWebImageManagerDelegate>
{
    // 滚动的view
...
- (void)setPhotos:(NSArray *)photos
{
    ...
    if (photos.count > 1) {
        _visiblePhotoViews = [[NSMutableSet alloc] initWithCapacity:_photos.count];
        _reusablePhotoViews = [[NSMutableSet alloc] initWithCapacity:_photos.count];
    }
...
//        [[SDWebImageManager sharedManager] downloadWithURL:photo.url delegate:self];
    }
