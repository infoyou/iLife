...
//            __unsafe_unretained MJPhoto *photo = _photo;
            ...
            [[SDWebImageManager sharedManager] downloadWithURL:_photo.url delegate:self];
            
//            [_imageView setImageWithURL:_photo.url placeholderImage:_photo.placeholder options:SDWebImageRetryFailed | SDWebImageLowPriority];
