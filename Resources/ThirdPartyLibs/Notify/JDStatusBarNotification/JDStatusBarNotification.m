...
@property (nonatomic, retain) JDStatusBarView *topBar;

@property (nonatomic, retain) NSTimer *dismissTimer;
@property (nonatomic, assign) CGFloat progress;

@property (nonatomic, retain) JDStatusBarStyle *activeStyle;
@property (nonatomic, retain) JDStatusBarStyle *defaultStyle;
@property (nonatomic, retain) NSMutableDictionary *userStyles;
@end
