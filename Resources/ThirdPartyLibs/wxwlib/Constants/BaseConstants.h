...
#define Arial_BOLD_FONT(aSize)     [UIFont fontWithName:@"Arial-BoldMT" size:aSize]
#define Arial_BOLD_ITALIC_FONT(aSize)     [UIFont fontWithName:@"Arial-BoldItalicMT" size:aSize]
#define Arial_ITALIC_FONT(aSize)          [UIFont fontWithName:@"Arial-ItalicMT" size:aSize]
