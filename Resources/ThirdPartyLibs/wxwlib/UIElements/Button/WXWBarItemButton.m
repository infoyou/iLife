...
- (id)initBackStyleButtonWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self setImage:[[ThemeManager shareInstance] getThemeImage:@"button_back.png"]
              forState:UIControlStateNormal];
        
        self.imageEdgeInsets = UIEdgeInsetsMake(10.0f, -10, 10.0f, 20);
    }
...
- (id)initRightButtonWithFrame:(CGRect)frame
    ...
    if (self) {
        ...
        [self setTitleColor:[[ThemeManager shareInstance] getColorWithName:@"kNaviBarTitleLabel"] forState:UIControlStateNormal];
    }
